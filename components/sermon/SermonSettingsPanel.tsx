    ...
    <div className="h-full flex flex-col bg-secondary">
      ...
      <div className="px-3 py-2 border-b border-border">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-medium text-foreground/90">{t('sermon.settingsPanelTitle')}</span>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-3 space-y-4">
        ...
        <div className="rounded-lg border border-border bg-card p-3">
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <p className="text-xs font-medium text-foreground/90">{t('sermon.settingsAiPreference')}</p>
          </div>
        ...
        {currentSermon && (
          <div className="rounded-lg border border-border bg-card p-3">
            <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider mb-2">{t('sermon.settingsInfo')}</p>
              ...
              <div className="rounded-lg border border-destructive/30 bg-destructive/5 p-2">
                ...
                <div className="flex gap-1.5">
                  <button
                    ...
                    className="flex-1 py-1.5 rounded-md text-[10px] font-medium bg-destructive text-destructive-foreground hover:bg-destructive/90 transition-colors"
                  >
                    {t('sermon.confirmDelete')}
                  </button>
                  <button
                    onClick={() => setShowDeleteConfirm(false)}
                    className="flex-1 py-1.5 rounded-md text-[10px] font-medium bg-muted text-muted-foreground hover:bg-secondary transition-colors"
                  >
                    {t('sermon.cancel')}
                  </button>
                </div>
