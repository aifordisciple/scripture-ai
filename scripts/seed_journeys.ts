...
const JOURNEYS_DATA = [
  ...
  },
  {
    ...
    stops: [
      ...
      { nameZh: '摩利亚山', verseRef: '创22:2', order: 8 },
    ],
  },
  {
    titleZh: '以色列人进迦南',
    journeyType: 'CONQUEST',
    yearStart: -1406,
    yearEnd: -1399,
    stops: [
      { nameZh: '什亭', verseRef: '书3:1', order: 1 },
      { nameZh: '约旦河', verseRef: '书3:14-17', order: 2 },
      { nameZh: '耶利哥', verseRef: '书6:1-27', order: 3 },
      { nameZh: '艾城', verseRef: '书8:1-29', order: 4 },
      { nameZh: '示剑', verseRef: '书8:30-35', order: 5 },
      { nameZh: '基遍', verseRef: '书9:3-27', order: 6 },
      { nameZh: '希伯仑', verseRef: '书10:36-37', order: 7 },
      { nameZh: '底璧', verseRef: '书10:38-39', order: 8 },
    ],
  },
  {
    titleZh: '保罗第一次宣教之旅',
  ...
  },
  {
    ...
    stops: [
      ...
      { nameZh: '加拉太', verseRef: '徒18:23', order: 2 },
      { nameZh: '以弗所', verseRef: '徒19:1-41', order: 3 },
      { nameZh: '马其顿', verseRef: '徒20:1-2', order: 4 },
      { nameZh: '希腊', verseRef: '徒20:2-3', order: 5 },
      { nameZh: '特罗亚', verseRef: '徒20:6-12', order: 6 },
      { nameZh: '米利都', verseRef: '徒20:17-38', order: 7 },
      { nameZh: '耶路撒冷', verseRef: '徒21:17', order: 8 },
    ],
  },
  {
    titleZh: '保罗押解罗马之旅',
  ...
  },
  {
    ...
    stops: [
      ...
      { nameZh: '埃及', verseRef: '太2:14', order: 2 },
      { nameZh: '拿撒勒', verseRef: '太2:23', order: 3 },
      { nameZh: '约旦河', verseRef: '太3:13', order: 4 },
      { nameZh: '旷野', verseRef: '太4:1', order: 5 },
      { nameZh: '迦拿', verseRef: '约2:1', order: 6 },
      { nameZh: '迦百农', verseRef: '太4:13', order: 7 },
      { nameZh: '加利利湖', verseRef: '太14:25', order: 8 },
      { nameZh: '该撒利亚腓立比', verseRef: '太16:13', order: 9 },
      { nameZh: '耶路撒冷', verseRef: '太21:1', order: 10 },
      { nameZh: '伯大尼', verseRef: '太21:17', order: 11 },
      { nameZh: '橄榄山', verseRef: '太24:3', order: 12 },
    ],
  },
  {
    titleZh: '雅各逃亡与归回',
    ...
    yearEnd: -1909,
    stops: [
      { nameZh: '别是巴', verseRef: '创28:10', order: 1 },
      { nameZh: '伯特利', verseRef: '创28:19', order: 2 },
      { nameZh: '哈兰', verseRef: '创29:4', order: 3 },
      { nameZh: '基列', verseRef: '创31:21', order: 4 },
      { nameZh: '玛哈念', verseRef: '创32:2', order: 5 },
      { nameZh: '毗努伊勒', verseRef: '创32:30', order: 6 },
      { nameZh: '示剑', verseRef: '创33:18', order: 7 },
      { nameZh: '希伯仑', verseRef: '创35:27', order: 8 },
    ],
  },
  {
    titleZh: '约瑟被卖到埃及',
    ...
    yearEnd: -1885,
    stops: [
      { nameZh: '希伯仑', verseRef: '创37:14', order: 1 },
      { nameZh: '多坍', verseRef: '创37:17', order: 2 },
      { nameZh: '埃及', verseRef: '创37:36', order: 3 },
      { nameZh: '歌珊地', verseRef: '创47:6', order: 4 },
    ],
  },
];
...
const ADDITIONAL_LOCATIONS = [
  ...
  },
  {
    ...
    significance: '保罗在此住了一年半，建立教会。在此写给帖撒罗尼迦教会的信。',
  },
  {
    nameZh: '以弗所',
    nameEn: 'Ephesus',
    ...
    region: '亚西亚',
    modernCountry: '土耳其',
    description: '亚西亚省的首府，有亚底米女神的大庙。',
    significance: '保罗在此住了三年，教导门徒。在此写给哥林多教会的信。',
  },
  {
    nameZh: '马其顿',
    nameEn: 'Macedonia',
    nameOriginal: 'Μακεδονία',
    aliases: [],
    latitude: 40.5000,
    longitude: 22.5000,
    region: '马其顿',
    modernCountry: '希腊/北马其顿',
    description: '希腊北部的地区。',
    significance: '保罗看见马其顿的异象，福音传入欧洲。',
  },
  {
    nameZh: '希腊',
    nameEn: 'Greece',
    ...
    region: '希腊',
    modernCountry: '希腊',
    description: '希腊半岛南部地区。',
    significance: '保罗第三次宣教旅程在此停留三个月。',
  },
  {
    nameZh: '米利都',
    nameEn: 'Miletus',
  ...
  },
  {
    ...
    modernCountry: '约旦',
    description: '约旦河东的城市。',
    significance: '雅各在此看见神的军兵。后来是以色列的一座逃城。',
  },
  {
    nameZh: '毗努伊勒',
    nameEn: 'Peniel',
    nameOriginal: 'פְּנִיאֵל',
    aliases: ['培尼伊勒'],
    latitude: 32.4000,
    longitude: 35.6333,
    region: '基列',
    modernCountry: '约旦',
    description: '雅博渡口附近的地方。',
    significance: '雅各在此与神摔跤，被改名为以色列。',
  },
];
